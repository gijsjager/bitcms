...
<div class="main-content container">
            ...
            if (count($languages) > 0) {
                ...
                <div class="dropdown-menu" role="menu" id="langmenu">
                    <?php foreach ($languages as $language) {
                        echo $this->Html->link($language->name, ['action' => 'edit', $page->id, 'language' => $language->abbreviation], ['class' => 'dropdown-item']);
                    } ?>
                </div>
                <?php
                echo '</span>';
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php
                    echo $this->Form->control('slug', ['prepend' => $this->Url->build('/', true)]);
    ...
    if (empty($page->block_groups)) {
        ...
        <div class="text-center mb-5">
            <?php
            $this->append('script', $this->Html->script(['../dotbits/js/Controllers/block_groups']));
