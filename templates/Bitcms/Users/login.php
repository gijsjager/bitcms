    ...
    <div class="main-content container">
        <div class="splash-container row">
            ...
            <div class="col-sm-6 form-message">
                <?= $this->Html->image('../dotbits/img/logo-inv.svg', ['alt' => 'Dotbits logo', 'style' => 'fill: white; height: 50px;', 'class' => 'logo-img mb-2']); ?>
                <span class="splash-description text-center mt-5 mb-5"><?= __('Login to your account'); ?></span>

                <?php
                echo $this->Form->create();
                echo $this->Form->input('username', ['autocomplete' => 'off', 'label' => false, 'placeholder' => __('Username'), 'prepend' => '<i class="icon s7-user"></i>']);
                echo $this->Form->input('password', ['autocomplete' => 'off', 'label' => false, 'placeholder' => __('Password'), 'prepend' => '<i class="icon s7-lock"></i>']);
